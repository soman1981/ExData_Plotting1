...
#Split device screen in 2 row 2 column format
par(mfrow =c (2,2))

#PLOT : Global Active Power v/s Datetime
plot(data2$Date, data2$Global_active_power, type="l", lwd="1", xlab="", ylab="Global Active Power")

#PLOT : Voltage v/s Datetime
plot(data2$Date, data2$Voltage, type="l", lwd="1", xlab="datetime", ylab="Voltage")
...
plot(data2$Date, data2$Global_reactive_power, type="l", lwd="1", xlab="datetime", ylab="Global_reactive_power")
